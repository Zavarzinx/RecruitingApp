                ...
                <div class="col-md-2">
                    ...
                    <b-modal id="modal-1" title="Edit profile">
                        <form>
                            ...
                            <div class="form-group">
                                <label>Password
                                    <h6>You need to relogin after password change</h6></label>
                                <input type="password" id="password" class="form-control" v-validate="{ required: true, min: 6 }" name="password" placeholder="password" required v-model="user.password" :class="{ 'is-invalid': submitted && vErrors.has('password') }"  />
